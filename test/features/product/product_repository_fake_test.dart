...
import 'package:flutter_project/features/product/data/repositories/product_repository_fake.dart';
import 'package:flutter_project/features/product/domain/entities/product_entity.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  group('ProductRepositoryFake', () {
    test('seeded repo returns the expected count', () async {
      final repo = ProductRepositoryFake.seeded(count: 3);
    ...
    test('add then getById round-trips', () async {
      final repo = ProductRepositoryFake();
      final added = await repo.add(const ProductEntity(
        id: '',
        name: 'New',
        description: 'desc',
      ));
    ...
    test('getAllPaginated returns the requested slice with hasMore', () async {
      final repo = ProductRepositoryFake.seeded(count: 25);
    ...
    test('search filters by name and description', () async {
      final repo = ProductRepositoryFake.seeded(count: 5);
