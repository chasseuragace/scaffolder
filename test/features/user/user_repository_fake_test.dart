...
import 'package:flutter_project/features/user/data/repositories/user_repository_fake.dart';
import 'package:flutter_project/features/user/domain/entities/user_entity.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  group('UserRepositoryFake', () {
    test('seeded repo returns the expected count', () async {
      final repo = UserRepositoryFake.seeded(count: 3);
    ...
    test('add then getById round-trips', () async {
      final repo = UserRepositoryFake();
      final added = await repo.add(const UserEntity(
        id: '',
        name: 'New',
        description: 'desc',
      ));
    ...
    test('getAllPaginated returns the requested slice with hasMore', () async {
      final repo = UserRepositoryFake.seeded(count: 25);
    ...
    test('search filters by name and description', () async {
      final repo = UserRepositoryFake.seeded(count: 5);
