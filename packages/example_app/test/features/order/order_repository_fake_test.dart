...
import 'package:flutter_project/features/order/data/repositories/order_repository_fake.dart';
import 'package:flutter_project/features/order/domain/entities/order_entity.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  group('OrderRepositoryFake', () {
    test('seeded repo returns the expected count', () async {
      final repo = OrderRepositoryFake.seeded(count: 3);
    ...
    test('add then getById round-trips', () async {
      final repo = OrderRepositoryFake();
      final added = await repo.add(const OrderEntity(
        id: '',
        name: 'New',
        description: 'desc',
      ));
    ...
    test('getAllPaginated returns the requested slice with hasMore', () async {
      final repo = OrderRepositoryFake.seeded(count: 25);
    ...
    test('search filters by name and description', () async {
      final repo = OrderRepositoryFake.seeded(count: 5);
