/// Details page for Order.
import React from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { useOrderById, useOrderMutations } from '../hooks/order.hooks';
...
export function OrderDetailsPage() {
  ...
  const { update, delete: deleteMutation } = useOrderMutations({ onSuccess: setSuccessMessage });
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="rounded border p-6">
        <h1 className="mb-4 text-2xl font-bold">{data.name ?? 'Unnamed Order'}</h1>
