/// Form dialog for adding/editing Order.
///
...
interface OrderFormDialogProps {
  ...
  entity?: OrderEntity;
  onClose: () => void;
  onSave: (entity: OrderEntity) => void;
}

export function OrderFormDialog({ isOpen, entity, onClose, onSave }: OrderFormDialogProps) {
  const [formData, setFormData] = useState<Omit<OrderEntity, 'id'> & { id: string }>({
    id: '',
    name: '',
    description: '',
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validate()) onSave(formData as OrderEntity);
  };
