...
import { useProductById, useProductMutations } from '../hooks/product.hooks';
...
export function ProductDetailsPage() {
  ...
  const { update, delete: deleteMutation } = useProductMutations();
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="rounded border p-6">
        <h1 className="mb-4 text-2xl font-bold">{data.name || 'Unnamed Product'}</h1>
