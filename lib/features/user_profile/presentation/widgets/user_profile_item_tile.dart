...
import '../pages/user_profile_details_page.dart';
...
class UserProfileItemTile extends ConsumerWidget {
  ...
  Future<void> _handleDelete(BuildContext context, WidgetRef ref) async {
    ...
    if (!ok) return;
    await ref.read(userProfileListProvider.notifier).remove(item.id);
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Card(
      ...
      child: ListTile(
        onTap: () => Navigator.of(context).push(UserProfileDetailsPage.route(item.id)),
